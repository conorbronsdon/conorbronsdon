...
I host [Chain of Thought](https://chainofthought.show), a podcast about AI infrastructure and the people building it. 50+ episodes, with guests from [Google DeepMind](https://newsletter.chainofthought.show/p/chain-of-thought-the-future-of-ai), NVIDIA, [AMD](https://podcasts.apple.com/us/podcast/amds-challenge-to-nvidia-the-open-ecosystem-bet-anush/id1776879655?i=1000713415927), Databricks, Liquid AI, [Fireworks](https://open.spotify.com/episode/6oXxA5WTffIF6HkqvcLChc?si=igo3O1sTRQmrjTZG7cD6bA), [Vercel](https://open.spotify.com/episode/3XCbiQj4EtTT6pZBSrwL5N?si=K5ThcjN5SMe7ZKOzTqSTIA), and others. I also write a [newsletter](https://newsletter.chainofthought.show/) on Substack.
