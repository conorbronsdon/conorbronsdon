...
| | Repo | What it does | |
|---|------|-------------|---|
| ✍️ | [avoid-ai-writing](https://github.com/conorbronsdon/avoid-ai-writing) | Open-source AI writing detector. 36 pattern categories, 109-word replacement table, two-pass rewrite. | [![Stars](https://img.shields.io/github/stars/conorbronsdon/avoid-ai-writing?style=social)](https://github.com/conorbronsdon/avoid-ai-writing) |
