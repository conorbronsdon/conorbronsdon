...
| | Repo | What it does | |
|---|------|-------------|---|
| ✍️ | [avoid-ai-writing](https://github.com/conorbronsdon/avoid-ai-writing) | Open-source AI writing detector & rewriter for Claude Code, Cowork, OpenClaw & Cursor. 53 pattern categories, 109-entry replacement table, two-pass rewrite, zero-dep detector engine. | [![Stars](https://img.shields.io/github/stars/conorbronsdon/avoid-ai-writing?style=social)](https://github.com/conorbronsdon/avoid-ai-writing) |
...
| 🗂️ | [agent-workspace](https://github.com/conorbronsdon/agent-workspace) | Memory and hygiene for agent workspaces: six lifecycle skills (start/end/update/today/reconcile/recover) with configurable state layout | [![Stars](https://img.shields.io/github/stars/conorbronsdon/agent-workspace?style=social)](https://github.com/conorbronsdon/agent-workspace) |
| 🔍 | [eval-integrity](https://github.com/conorbronsdon/eval-integrity) | Benchmark-credibility auditor: 36 sub-checks across seven dimensions, JSON result schema, three audit fixtures — would your published numbers survive an adversarial reviewer? | [![Stars](https://img.shields.io/github/stars/conorbronsdon/eval-integrity?style=social)](https://github.com/conorbronsdon/eval-integrity) |
| 📌 | [ssot-check](https://github.com/conorbronsdon/ssot-check) | Fact-copy drift auditor: deterministic stdlib CLI + skill wrapper + pre-commit hook + GitHub Action, one canonical home per fact | [![Stars](https://img.shields.io/github/stars/conorbronsdon/ssot-check?style=social)](https://github.com/conorbronsdon/ssot-check) |
| 🏗️ | [agent-skill-builder](https://github.com/conorbronsdon/agent-skill-builder) | Build agent skills that don't rot: scaffolds with the design decisions most generators skip (invocation control, arguments, context budget), validates mechanically, and pins its spec knowledge to a CI-watched snapshot | [![Stars](https://img.shields.io/github/stars/conorbronsdon/agent-skill-builder?style=social)](https://github.com/conorbronsdon/agent-skill-builder) |
...
| 🎬 | [demo-gif-skill](https://github.com/conorbronsdon/demo-gif-skill) | Claude Code skill that adds a reproducible demo GIF to any repo's README in one prompt — vhs for terminals, Playwright for web, auto-optimized under 8 MB and committed so it regenerates instead of going stale | [![Stars](https://img.shields.io/github/stars/conorbronsdon/demo-gif-skill?style=social)](https://github.com/conorbronsdon/demo-gif-skill) |
